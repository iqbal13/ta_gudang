      ...
      <div class="row">
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-success">
            ...
            <div class="box-body">
                              <br />
                              <form method="POST" action="<?php echo $url ?>aksi.php?aksi=keluarbarang">
...
<!--                 <a class="btn btn-primary" type="button"> Tambah Data </a>
 -->                <br />
              ...
              <table class="table table-stripped" id="tabel-data">
                ...
                <tbody>
                  <?php 
                  $query = mysqli_query($conn,"SELECT barang_keluar.*,barang.nama_barang FROM barang_keluar LEFT JOIN barang ON barang_keluar.kode_barang = barang.kode_barang ORDER BY tanggal_keluar DESC");
                  $no = 1;
                  while($dt = mysqli_fetch_array($query)){ 

                    $tanggal_tambah = $dt['tanggal_keluar'];
